...
taic_up = [5732, 3444, 2209, 1577, 1272, 1156]
taic_smp = [3547, 2190, 1181, 830, 774, 770]
...
plt.bar(x - 3 *width, sync_up_fp, width, label='sync-up-fp', color = "black", edgecolor='black')
plt.bar(x - 2 * width, sync_up, width, label='sync-up', color='brown', edgecolor='black')
plt.bar(x - width, sync_smp, width, label='sync-smp', color="darkorange", edgecolor='black')
plt.bar(x, async_up, width, label='async-up', color="palegreen", edgecolor='black')
plt.bar(x + width, async_smp, width, label='async-smp', color="cyan", edgecolor='black')
plt.bar(x + 2 * width, taic_up, width, label='taic-up', color="dodgerblue", edgecolor='black')
plt.bar(x + 3 * width, taic_smp, width, label='taic-smp', color="m", edgecolor='black')
